...
(function() {
    ...
    JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
      ...
      build: function() {
        ...
        // If the object should be rendered as a div
          ...
          this.addproperty_input.setAttribute('placeholder','属性名称');
          ...
          // Edit JSON Button
          this.editjson_button = this.getButton('JSON','edit','编辑JSON');
          ...
          this.addproperty_button = this.getButton('Properties','edit','对象属性');
    ...
    JSONEditor.defaults.languages.en = {
       ...
       */
      error_enum: "值必须是枚举值中的一个",
      /**
       * When a value doesn't validate any schema of a 'anyOf' combination
       */
      error_anyOf: "值必须符合至少一个提供的 schemas",
      /**
       * When a value doesn't validate
       * @variables This key takes one variable: The number of schemas the value does not validate
       */
      error_oneOf: '值必须符合指定的一个提供的 schemas. 目前符合 {{0}} 个schemas.',
      /**
       * When a value does not validate a 'not' schema
       */
      error_not: "值必须不能符合提供的 非schemas",
      /**
       * When a value does not match any of the provided types
       */
      error_type_union: "值必须为提供类型中的一个",
      /**
       ...
       */
      error_disallow_union: "值不能为提供的不可用类型",
      /**
       *  When the value validates a disallowed type
       * @variables This key takes one variable: The type the value should not be of
       */
      error_disallow: "值不能是 {{0}} 类型",
      /**
       * When a value is not a multiple of or divisible by a given number
       * @variables This key takes one variable: The number mentioned above
       */
      error_multipleOf: "值必须是多个 {{0}}",
      /**
       * When a value is greater than it's supposed to be (exclusive)
       * @variables This key takes one variable: The maximum
       */
      error_maximum_excl: "值最少为 {{0}} 个",
      /**
       * When a value is greater than it's supposed to be (inclusive
       * @variables This key takes one variable: The maximum
       */
      error_maximum_incl: "值最多为 {{0}} 个",
      /**
       ...
       * @variables This key takes one variable: The minimum
       */
      error_minimum_incl: "值必须小于 {{0}}",
      /**
       * When a value have too many characters
       * @variables This key takes one variable: The maximum character count
       */
      error_maxLength: "值最多包含 {{0}} 个字符长度",
      /**
       * When a value does not have enough characters
       * @variables This key takes one variable: The minimum character count
       */
      error_minLength: "值最少包含 {{0}} 个字符长度",
      /**
       * When a value does not match a given pattern
       */
      error_pattern: "值必须符合规则 {{0}}",
      /**
       * When an array has additional items whereas it is not supposed to
       */
      error_additionalItems: "该数组不允许额外的元素",
      /**
       * When there are to many items in an array
       * @variables This key takes one variable: The maximum item count
       */
      error_maxItems: "值至多包含 {{0}} 个元素",
      /**
       * When there are not enough items in an array
       * @variables This key takes one variable: The minimum item count
       */
      error_minItems: "值至少包含 {{0}} 个元素",
      /**
       * When an array is supposed to have unique items but has duplicates
       */
      error_uniqueItems: "数组必须含有唯一的元素items，但是含有了多个",
      /**
       * When there are too many properties in an object
       * @variables This key takes one variable: The maximum property count
       */
      error_maxProperties: "对象必须至多包含 {{0}} 个属性",
      /**
       * When there are not enough properties in an object
       * @variables This key takes one variable: The minimum property count
       */
      error_minProperties: "对象必须至少包含 {{0}} 个属性",
      /**
       * When a required property is not defined
       * @variables This key takes one variable: The name of the missing property
       */
      error_required: "对象缺少必填属性 '{{0}}'",
      /**
       * When there is an additional property is set whereas there should be none
       * @variables This key takes one variable: The name of the additional property
       */
      error_additional_properties: "不允许额外的属性, 但是设置了 {{0}} ",
      /**
       * When a dependency is not resolved
       * @variables This key takes one variable: The name of the missing property for the dependency
       */
      error_dependency: "必须有属性： {{0}}",
      /**
